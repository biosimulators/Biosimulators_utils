...
class GetVariableForSimulationTestCase(unittest.TestCase):
    ...
    def test_core_one_step(self):
        params, sims, vars = get_parameters_variables_for_simulation(self.CORE_FIXTURE, ModelLanguage.SBML, OneStepSimulation, 'KISAO_0000019')
    ...
    def test_fbc_steady_state_fba(self):
        params, sims, vars = get_parameters_variables_for_simulation(self.FBC_FIXTURE, ModelLanguage.SBML, SteadyStateSimulation, 'KISAO_0000437')
    ...
    def test_fbc_steady_state_fva(self):
        params, sims, vars = get_parameters_variables_for_simulation(self.FBC_FIXTURE, ModelLanguage.SBML, SteadyStateSimulation, 'KISAO_0000526')
    ...
    def test_qual_one_step(self):
        params, sims, vars = get_parameters_variables_for_simulation(self.QUAL_FIXTURE, ModelLanguage.SBML, OneStepSimulation, 'KISAO_0000450')
